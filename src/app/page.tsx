...
const ThreeScene = dynamic(() => import('@/components/portfolio/ThreeScene'), {
  ssr: false,
  loading: () => <div className="w-full h-[400px] md:h-[500px] bg-muted rounded-lg flex items-center justify-center"><p>Loading 3D Scene...</p></div>,
});
...
export default function PortfolioPage() {
  ...
  return (
    <div className="space-y-12">
      <section aria-labelledby="welcome-heading" className="text-center py-12 md:py-16 bg-gradient-to-br from-background to-primary/10 rounded-xl shadow-inner">
