...
export default function PortfolioPage() {
  return (
    <div className="py-6 px-4 sm:px-6 lg:px-12 mt-8 text-center">
      ...
      <p className="mb-4">
        If you no longer see the "Internal Server Error", the issue was likely in the
      ...
      <div className="mt-12 p-6 bg-card border rounded-lg text-left">
        ...
        <p className="mb-2">
          <strong>Please check your Next.js server terminal (where you run `npm run dev`).</strong>
        </p>
        <p className="mb-2">
          It will contain the full, detailed error message and stack trace that reveals the exact cause of the "Internal Server Error".
        </p>
        <p>
